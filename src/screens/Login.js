...
GoogleSignin.configure({
    webClientId: '328171739477-3ca0hjijo1nmtefdddj4qspd9itaj31b.apps.googleusercontent.com',
});
                    ...
                    onPress={() => { 
                        email, password ?
                            ...
                            if (data) {
                                ...
                                Alert.alert('Welcome!', '', [{ text: 'OK', style: 'destructive' }])
                            }
...
const style = StyleSheet.create({
    input: {
        ...
        width: width / 1.2,
        height: 48,
        backgroundColor: 'rgba(180, 105, 189, 1)',
        color: 'rgba(255, 255, 255, .9)',
        borderWidth: 1,
        borderColor: 'rgba(180, 105, 189, 1)', 
        borderRadius: 5,
        paddingLeft: 10,
        marginVertical: 5,
    },
